...
with open('./data/YAGO15K-FB15K/attrValue_ids_1', 'w') as f:
...
with open('./data/YAGO15K-FB15K/attrValue_ids_2', 'w') as f:
...
with open(pjoin('data', 'YAGO15K-FB15K', 'attrValue_triplets_1'), 'w') as f1, open(pjoin('data', 'YAGO15K-FB15K', 'attrValue_triplets_2'), 'w') as f2:
    for i, attrs in enumerate(id2attrs):
        if i < len(source2id):
            for attr, value, schema in attrs:
...
with open(pjoin('data', 'YAGO15K-FB15K', 'source2attr.npy'), 'wb') as f1, open(pjoin('data', 'YAGO15K-FB15K', 'target2attr.npy'), 'wb') as f2:
